  ...
  return (
    <div className="bg-[#e7e7e7] md:pt-28 pt-10 px-10 ">
      ...
      <div className="text-center max-w-[850px] mx-auto">
        ...
        <h4 className="text-[#d2ac6e] text-xs ">ARCHITECTURE & INTERIOR</h4>
      ...
      <div className="border-t border-[#d2ac6e38] py-5 text-[#61616181] text-center md:text-base text-sm">
        <h2>
          Copyright 2024 © All Right Reserved By Mukthar Interiors
        </h2>
      </div>
    </div>
  );
